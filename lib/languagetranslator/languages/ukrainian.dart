...
class LearnUkrainian extends StatefulWidget {
  @override
  State<LearnUkrainian> createState() => _LearnUkrainianState();
}

class _LearnUkrainianState extends State<LearnUkrainian> {
  ...
  final _targetLanguage = TranslateLanguage.ukrainian;
