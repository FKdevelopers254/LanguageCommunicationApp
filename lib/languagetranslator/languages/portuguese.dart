...
class LearnPortuguese extends StatefulWidget {
  @override
  State<LearnPortuguese> createState() => _LearnPortugueseState();
}

class _LearnPortugueseState extends State<LearnPortuguese> {
  ...
  final _targetLanguage = TranslateLanguage.portuguese;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          title:  Text('Learn $_targetLanguage'),
        ),
