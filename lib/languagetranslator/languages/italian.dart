...
class LearnItalian extends StatefulWidget {
  @override
  State<LearnItalian> createState() => _LearnItalianState();
}

class _LearnItalianState extends State<LearnItalian> {
  ...
  final _targetLanguage = TranslateLanguage.italian;
