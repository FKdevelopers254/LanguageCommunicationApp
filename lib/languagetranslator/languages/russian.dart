...
class LearnRussian extends StatefulWidget {
  @override
  State<LearnRussian> createState() => _LearnRussianState();
}

class _LearnRussianState extends State<LearnRussian> {
  ...
  final _targetLanguage = TranslateLanguage.russian;
