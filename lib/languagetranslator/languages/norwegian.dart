...
class LearnNorwegian extends StatefulWidget {
  @override
  State<LearnNorwegian> createState() => _LearnNorwegianState();
}

class _LearnNorwegianState extends State<LearnNorwegian> {
  ...
  final _targetLanguage = TranslateLanguage.norwegian;
