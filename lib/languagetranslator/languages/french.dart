...
class LearnFrench extends StatefulWidget {
  @override
  State<LearnFrench> createState() => _LearnFrenchState();
}

class _LearnFrenchState extends State<LearnFrench> {
  ...
  final _targetLanguage = TranslateLanguage.french;
