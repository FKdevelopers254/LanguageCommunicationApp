...
class LearnDutch extends StatefulWidget {
  @override
  State<LearnDutch> createState() => _LearnDutchState();
}

class _LearnDutchState extends State<LearnDutch> {
  ...
  final _targetLanguage = TranslateLanguage.dutch;
