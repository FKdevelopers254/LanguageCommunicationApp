...
class LearnTurkish extends StatefulWidget {
  @override
  State<LearnTurkish> createState() => _LearnTurkishState();
}

class _LearnTurkishState extends State<LearnTurkish> {
  ...
  final _targetLanguage = TranslateLanguage.turkish;
